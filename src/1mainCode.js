...
import threeDotsIcon from './media/three-dots.png'; // Import the three-dots icon
...
export default function MainCode() {
  ...
  const [rowData, setRowData] = useState(
    Array(10).fill({ name: '', affiliation: '', initiative: null }) // NEW: Now store initiative too
  );
  ...
  // Sort the visible rows before displaying
  // Sort visible rows, keeping overlays at the bottom
      ...
      <div className="container">
        <div className="initiative-list">
          <div className="initiative-banner">
            <div className="round-counter">Round Counter</div>
            ...
            <div key={index} className="row">
              ...
              <div className="view-character-conditions">
                <button className="view-button">
                  <img src={plusIcon} alt="View Icon" className="view-icon" />
                </button>
              </div>
